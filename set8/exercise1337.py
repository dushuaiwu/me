...
def set_it_on_fire(input_string="very naughty boy") -> str:
    ...
    strings = list(input_string.upper())
...
def best_letter_for_pets() -> str:
    ...
    for alpha in all_alpha:
        num = len(pet_filter(alpha))
        if num > longest:
            longest = num
            most_popular_letter = alpha
...
def random_filler_text(number_of_words=200) -> str:
    ...
    for i in range(number_of_words):
        word_first_index = random.randint(3, 7)
        word_second_index = random.randint(0, 3)
        words.append(my_dict[word_first_index][word_second_index])
    return " ".join(words)
...
def fast_filler(number_of_words=200) -> str:
    ...
    for i in range(number_of_words):
        word_first_index = random.randint(3, 7)
        word_second_index = random.randint(0, 3)
        word_first_index = str(word_first_index)
        words.append(my_dict[word_first_index][word_second_index])
